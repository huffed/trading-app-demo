...
### E2.10 — Portfolio composer execution on 108 Layer B FTMO-passers (~1 day build + ~15min compute) [FILED 2026-06-29 LATE post-E2.7.5-empirical; PRE-EMPTS E2.8/E2.9 IN PRIORITY ORDER]
...
| 2026-06-29 EVE | **E2.10 BUILT + PRE-REGISTERED + RUN — PASS, 3-algo deployable portfolio composed.** 111 FTMO-passing Layer B variants entered universe (post-filter); greedy selector accepted 3 + skipped 108 due to pairwise correlation gate (mostly > 0.40 within and across patterns at 4h gold). Portfolio: ARB rr3_lb6_r1_rf1_af0 ($10,767, DD 9.21%) + Engulfing rr3_lb6_r1_rf0_af1 ($9,516, DD 9.33%) + Engulfing rr2_lb4_r1_rf1_af0 ($3,603, DD 8.74%). **Combined DD 9.66% ≤ FTMO 10%** ✓; all 3 pairwise correlations < 0.40 ✓ (max 0.352, ARB↔Engulfing-rr3); $23,886 total return / 471 trades / 10.5yr / ~12.4%/yr per algo. Acceptance packet at `e2-results/portfolio-acceptance-2026-06-29.md` — recommends operator G.6 STAMP + unpause for demo (paper-only first 5-10 trades to verify backtest-live alignment, then track 30 trades per algo, escalate to real FTMO if alignment holds). E2.8 + E2.9 no longer needed unless G.6 declines. Commits 4384812 (pre-reg lock) + 5125f87 + dcc6526 + this commit on dev. | portfolio-2026-06-29.json + portfolio-acceptance-2026-06-29.md |
