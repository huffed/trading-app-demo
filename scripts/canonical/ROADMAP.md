...
### E2.28 — Risk-weighted (non-uniform) portfolio allocation [FILED 2026-07-20, operator-prompted "search for faster algos"; POST-M1, $0]
...
- **Status:** FILED, POST-M1 / operator-optional. ~half-day build on the existing harness.
