    ...
    <>
      <div className="divide-y">
        {items.map((item) => (
          <WatchlistRow
            ...
            isChecking={
              checkingTicker === item.ticker || (isCheckingAll && !signalResults[item.ticker])
            }
            onCheck={() => handleCheck(item.ticker)}
      ...
      {hasSentiment && (
        <Button
          ...
          disabled={isCheckingAll || !!checkingTicker}
          className="w-full"
        >
